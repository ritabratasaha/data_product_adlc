...
Describe the grain of the table, its purpose and any edge cases. Study **`models/docs/<layer>/<model>.md`** if it exists to create a short and meaningful description of the model
